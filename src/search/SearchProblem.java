...
/**
 * This class defines the default behavior of a search problem.
 * Any class model a domain-specific search problem must extend this class.
 * @author Kit-ying Hui
 *
 */
public abstract class SearchProblem {
	 ...
	 * The default strategy is adding the child to the end of the fringe, giving a breadth-first behavior.
